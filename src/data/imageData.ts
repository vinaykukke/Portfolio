...
const images = [
  ...
  },
  {
    ...
    about:
      "PharmEasy is an Indian healthcare “super app” that provides consumers with on-demand, home delivered access to a wide range of prescription, OTC pharmaceutical, other consumer healthcare products, comprehensive diagnostic tests, and teleconsultations services",
  },
  {
